...
class LynxHingeInline(Module):
    """SES-PRO hinge with inline tube (outgoing link along +Y)."""
    ...
    def __init__(
        ...
        index: int,
        *,
        tube_length: float = 0.118,  # not rendered here, but kept for parity
        ...
        # Rotor (tube segment visual along +Y)
        ...
        # Attachment site at tube tip
        self.sites = {}
        self.sites[ModuleFaces.FRONT] = rotor.add_site(
            name=f"lynx_inline_front_{index}",
